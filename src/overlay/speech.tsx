...
export const Speech = () => {
    ...
    return (
        <>
            ...
            <SpeechBubble activeSpeechBubble={activeSpeechBubble.get} />
        </>
    )
}

export const SpeechBubble = ({ activeSpeechBubble }: { activeSpeechBubble: string }) => {
    return (
        <div className="bg-white p-4 rounded-lg shadow-lg w-3/4 border-2 border-gray-300 relative">
            <p className="text-xl font-medium text-gray-800">{activeSpeechBubble}</p>
        </div>
    )
}
